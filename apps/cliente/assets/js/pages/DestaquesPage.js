...
// =============================================================
// DestaquesPage.js — Tela "Top Barbearias" do app cliente.
  ...
  bind() {
    ...
    if (digEl) {
      this.#dig = new DigText(digEl, [
        'Explore as barbearias mais bem avaliadas no BarberFlow. Ordenadas por pontuação e número de cortes, as mais populares oferecem o melhor serviço, enquanto as menos avaliadas mostram novas opções. Encontre a sua favorita e agende já o seu corte.'
      ], { velocidade: 20 });
    }

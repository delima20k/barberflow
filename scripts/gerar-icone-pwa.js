...
const LOGO    = path.join(__dirname, '../shared/img/Logo01.png');
const OUT_512 = path.join(__dirname, '../shared/img/icon-512.png');
const OUT_192 = path.join(__dirname, '../shared/img/icon-192.png');
...
(async () => {
  await gerarIcone(512, OUT_512);
  await gerarIcone(192, OUT_192);

...
| Analytics de landing no Supabase compartilhado / schema isolado / eventos / dashboard | `skill-05-banco.md` (Analytics no schema isolado do Supabase compartilhado), `skill-03-backend.md`, `skill-04-seguranca.md`, `skill-07-testes.md` |

 ...
 *
 * Store: { correlationId, traceId, requestId, userId }
 *
 * Uso:
...
class CorrelationContext {
   ...
   *
   * @param {{ correlationId?: string, traceId?: string, requestId?: string, userId?: string }} initial
   * @param {() => void} fn
   */
   ...
   * @returns {{ correlationId?: string, traceId?: string, requestId?: string, userId?: string }}
   */
  static getStore() {

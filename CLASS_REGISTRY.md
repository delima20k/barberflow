...
| `MediaManager` | [src/services/MediaManager.js](src/services/MediaManager.js) | application | Sistema híbrido de mídia P2P+R2+Supabase. Integra EncryptionService, ChunkService, HashService, FallbackService, CacheService e PeerHealthService. Contextos: stories/avatars/services/portfolio. Métodos: uploadMedia(), downloadMedia(), gerarUrlPresigned(), confirmarUpload(), processarUploadSeguro(), deletar(), listar(), publicUrl(). Constructor aceita opts: { peerHealth, cache, p2pUploader, p2pDownloader }. |

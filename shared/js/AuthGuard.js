...
class AuthGuard {
  ...
  static #MSG_POPUP = Object.freeze({
    ...
    'portfolio-like':        'Para curtir fotos do portfólio, você precisa estar logado.',
    'portfolio-message':     'Para enviar mensagem sobre uma foto, você precisa estar logado.',
